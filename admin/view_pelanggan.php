        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              $sql1=mysql_query("SELECT * FROM pelanggan WHERE status='1'");
              ...
              ?><tr>
                  ...
                  <td align="center">
                      ...
                      <a class="action" href="hapus_pelanggan.php?kd=<?php echo $bc1['id_pelanggan'];?>" style="padding:2.3px 4px 2.3px 8px;" >
