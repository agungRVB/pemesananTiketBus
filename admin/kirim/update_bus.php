...
<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
  <h1 class="box-title" style="font-size:150%;">Data Bus</h1>
</div>
<section class="content-header">
  <font size="4px">Edit Data Bus</font>
</section>
 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="nm_bus" value="<?php echo"$bc[nm_bus]"; ?>" placeholder="" required></td>
        </div>
      </tr>
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Kode Bus</label></td><td>:</td>
          <td><input type="text" class="form-control" name="nmr_bus" value="<?php echo"$bc[nmr_bus]"; ?>" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Nomor Polisi</label></td><td>:</td>
          <td><input type="text" class="form-control" name="plat_nmr" value="<?php echo"$bc[plat_nmr]"; ?>" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Kapasitas Penumpang</label></td><td>:</td>
          <td><input type="text" class="form-control" name="no_duduk" value="<?php echo"$bc[no_duduk]"; ?>" placeholder="" required></td>
          </div>
      </tr>
        <td></td>
...
if (isset($_POST['submit'])) {
  include '../config/koneksi.php';
       mysql_query("UPDATE bus SET nm_bus='$nm_bus', nmr_bus='$nmr_bus', plat_nmr=$plat_nmr, no_duduk='$no_duduk' WHERE kd_bus='$_GET[kd]'");
       ?>
