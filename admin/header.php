...
<html>
  <head>
    ...
    <title>Ismiati Bus Agency</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"><b>ISMIYATI</b>BUS AGENCY</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <span style="color:white; font-size:30;"><b></b></span>
        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <pixels>Hi.. Admin<?php// echo $nama;?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="?menu=bus"><i class="fa fa-bus" style="color:orange"></i> <span  style="color:orange">Data Bus</span></a></li>
            <li><a href="?menu=tiket"><i class="fa fa-ticket" style="color:orange"></i> <span  style="color:orange">Tiket</span></a></li>
            <li><a href="?menu=pelanggan"><i class="fa fa-users" style="color:orange"></i> <span  style="color:orange">Pelanggan</span></a></li>
            <li><a href="?menu=pembayaran"><i class="fa fa-money" style="color:orange"></i> <span  style="color:orange">Pembayaran</span></a></li>
            <li><a href="?menu=user"><i class="fa fa-user-plus" style="color:orange"></i> <span  style="color:orange">Kelola User</span></a></li>
            <li><a href="?menu=laporan-bus"><i class="fa  fa-file-text-o" style="color:orange"></i> <span  style="color:orange">Laporan Bus</span></a></li>
            <li><a href="?menu=laporan-pelanggan"><i class="fa  fa-file-text-o" style="color:orange"></i> <span  style="color:orange">Laporan Pelanggan</span></a></li>
            <li><a href="?menu=laporan-tiket"><i class="fa  fa-file-text-o" style="color:orange"></i> <span  style="color:orange">Laporan Tiket</span></a></li>
            <li><a href="?menu=laporan-pembayaran"><i class="fa  fa-file-text-o" style="color:orange"></i> <span  style="color:orange">Laporan Pembayaran</span></a></li>
            <li><a href="?menu=laporan-pemesanan"><i class="fa  fa-file-text-o" style="color:orange"></i> <span  style="color:orange">Laporan Pemesanan</span></a></li>
