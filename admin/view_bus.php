<div class="box-header with-border" style="border-bottom:1px solid #E6E4E4;padding-left:15px;background:#F5F4FD">
    <h1 class="box-title" style="font-size:150%;">Kelola Bus</h1>
</div>
<!-- Main content -->
<section class="content">
  <div class="row">
          <a href="?menu=input-bus" style="color:#595757;float:right;">
          ...
          <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
            ...
            $no=1;
              ...
              ?><tr>
                  ...
                  <td><?php echo $bc1['plat_nmr']; ?></td>
                  <td><?php echo $bc1['no_duduk']; ?> Tempat Duduk</td>

                  <td align="center">
                      <a class="action" href="?menu=edit-bus&kd=<?php echo $bc1['kd_bus']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
                        <i class="fa fa-edit" style="color:green;"> </i>Ubah
                      </a>
                      <a class="action" href="hapus_bus.php?kd=<?php echo $bc1['kd_bus'];?>" style="padding:2.3px 4px 2.3px 8px;" >
