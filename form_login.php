 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="nama_user" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
        ...
        <td colspan="2"><div class="box-footer">
              <button type="submit" name="login" class="btn btn-primary"><i class="fa fa-save"></i> &nbsp Login</button> &nbsp
