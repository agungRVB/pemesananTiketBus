        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <pixels>Hi.. Manager<?php// echo $nama;?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="?menu=laporan-pemesanan"><i class="fa  fa-book" style="color:orange"></i> <span  style="color:orange">Laporan Pemesanan</span></a></li>
